...
from PIL import ImageTk # импортируем модуль PIL (Pillow)
root = Tk()
...
img = ImageTk.PhotoImage(file=r"C:\images\image.jpg") # используем PIL (Pillow), добавляем картинку-поздравление
